              ...
              <div key={key} className="space-y-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <input
                    ...
                    value={theme[key] || ""}
                    onChange={(e) => setTheme({ ...theme, [key]: e.target.value })}
                    className="bg-background border border-border rounded px-3 py-2 text-sm text-foreground font-mono focus:border-primary focus:outline-none transition-colors flex-1"
                  />
                </div>
              </div>
            ))}
        ...
        <section className="p-6 rounded border border-border bg-surface-dark/50 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest">Display Font</label>
              <input
                type="text"
                value={theme.font_display || ""}
                onChange={(e) => setTheme({ ...theme, font_display: e.target.value })}
                className="w-full bg-background border border-border rounded px-3 py-2 text-sm text-foreground font-mono focus:border-primary focus:outline-none transition-colors"
              />
              <p className="text-[10px] text-muted-foreground font-mono">Used for headings and UI labels</p>
            </div>
            <div className="space-y-2">
              <label className="text-[10px] font-mono text-muted-foreground uppercase tracking-widest">Serif Font</label>
              <input
                type="text"
                ...
                className="w-full bg-background border border-border rounded px-3 py-2 text-sm text-foreground font-mono focus:border-primary focus:outline-none transition-colors"
              />
              <p className="text-[10px] text-muted-foreground font-mono">Used for decorative headings</p>
            </div>
          </div>
        </section>
        ...
        <section className="p-6 rounded border border-border space-y-4" style={{ background: theme.background_color }}>
          ...
          <div className="p-4 rounded border" style={{ borderColor: theme.border_color, background: theme.surface_color }}>
            ...
            <div className="flex gap-2 mt-4">
              <span className="px-3 py-1 rounded text-xs font-mono" style={{ background: `${theme.primary_color}20`, color: theme.primary_color, border: `1px solid ${theme.primary_color}40` }}>Primary</span>
              <span className="px-3 py-1 rounded text-xs font-mono" style={{ background: `${theme.accent_color}20`, color: theme.accent_color, border: `1px solid ${theme.accent_color}40` }}>Accent</span>
              <span className="px-3 py-1 rounded text-xs font-mono" style={{ background: `${theme.gold_color}20`, color: theme.gold_color, border: `1px solid ${theme.gold_color}40` }}>Gold</span>
            </div>
          </div>
        </section>
      </div>
